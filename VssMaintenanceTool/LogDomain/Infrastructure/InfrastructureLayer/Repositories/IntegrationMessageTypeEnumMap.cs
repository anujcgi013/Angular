...
{
    public class IntegrationMessageTypeEnumMap: ClassMapping<IntegrationMessageTypeEnum>
    {
        public IntegrationMessageTypeEnumMap()
        {
            Table("[IntegrationMessageTypeEnum]");
            Schema("[dbo]");
            Lazy(true);
